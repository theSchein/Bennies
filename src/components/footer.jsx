...
<footer className="bg-teal-900 text-white py-8">
    <div className="container mx-auto px-4">
            ...
            <div className="footer-section text-center sm:text-left">
                <a href="Discovry.pdf" download="Discovry.pdf" className="text-blue-400 hover:text-blue-500 transition-colors duration-300 text-xl font-semibold mb-2">Download Pitchdeck</a>
