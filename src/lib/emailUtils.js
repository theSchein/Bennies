    ...
    <body>
      ...
      <div class="content">
        ...
        <div class="social-links">
          <table>
            <tr>
              ${data.twitter_link ? `<td><a href="${twitterBaseUrl}${data.twitter_link.startsWith('@') ? data.twitter_link.slice(1) : data.twitter_link}" target="_blank"><img src="https://shuk.nyc3.cdn.digitaloceanspaces.com/logo/twitter_logo.png" alt="Twitter"><br>${data.twitter_link}</a></td>` : ""}
              ${data.discord_link ? `<td><a href="${discordBaseUrl}${data.discord_link.startsWith('@') ? data.discord_link.slice(1) : data.discord_link}" target="_blank"><img src="https://shuk.nyc3.cdn.digitaloceanspaces.com/logo/discord_logo.png" alt="Discord"><br>${data.discord_link}</a></td>` : ""}
              ${data.telegram_link ? `<td><a href="${telegramBaseUrl}${data.telegram_link.startsWith('@') ? data.telegram_link.slice(1) : data.telegram_link}" target="_blank"><img src="https://shuk.nyc3.cdn.digitaloceanspaces.com/logo/telegram_logo.png" alt="Telegram"><br>${data.telegram_link}</a></td>` : ""}
            </tr>
          </table>
        </div>
