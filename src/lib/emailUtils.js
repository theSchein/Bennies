...
const generateOnboardEmailHtml = (data, username, collectionName, collectionLink) => {
...
export const sendOnboardingEmail = async (email, username, collectionName, collectionLink, emailData) => {
    const emailHtml = generateOnboardEmailHtml(emailData, username, collectionName, collectionLink);
