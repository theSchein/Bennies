  ...
  return (
    <div className="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white shadow-xl rounded-lg p-8 mx-auto max-w-3xl">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">{"Under Construction"}</h2>
          <p className="text-gray-600 mb-4">{"My first whitepaper was too long winded and pretentious. I will be publishing a cleaner paper and pitch deck by November 11th."}</p>
</section>
